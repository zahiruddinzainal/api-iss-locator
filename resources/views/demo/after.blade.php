...
<body>
            ...
            <div class="login__inner">
                <div class="login__header">
                    <div class="login__title">
                        <h1 class="login__heading">ISS Locator<br><span style="font-size: 20px;">(after every 10 minutes)</span></h1>
                    </div>
                </div>
    ...
    <script>
        ...
        button.onclick = function() {
            ...
            if (satelite_id && date) {
                window.location.href = '/api/after/satelite/' + satelite_id + '/timestamp/' + Date.parse(date);
            }
        };
    </script>
